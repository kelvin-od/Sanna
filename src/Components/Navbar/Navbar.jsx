...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className='sticky top-0 bg-white-500 md:py-2 py-3 border-b-1 border-gray-200 shadow-md'>
                <div className="flex items-center justify-between mx-6 mr-24">
                    <div className='flex gap-4 sm:flex-row items-center'>
                        ...
                        <div className='flex-grow md:flex-grow-0 w-80 md:w-96'>
                            <input className='rounded-full md:rounded-lg py-5 w-full h-8 border focus:outline-none bg-white md:bg-green-50 px-3' type="text" placeholder='Search' />
                        </div>
                    </div>
                    <ul className='hidden md:flex flex justify-between space-x-8'>
                    {/* <li className='text-base hover:cursor-pointer px-3 py-2 rounded-lg'>
                        <Link to="/messaging" className='flex flex-col items-center text-gray-700 text-sm hover:text-green-700 relative' onClick={handleMessageClick}>
                            ...
                            {messageCount > 0 &&
                                <span className="absolute top-0 right-0 text-tiny bg-red-500 text-white rounded-full px-1">{messageCount}</span>
                            }
                        </Link>
                    </li> */}
                        <li className='text-base hover:cursor-pointer px-3 py-2 rounded-lg'>
